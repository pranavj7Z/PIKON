package com.Z.pikonlib.adapter;
...
public class StickerTypeAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public static final String[] stickerPath = {"stickers/type1", "stickers/type2", "stickers/type3", "stickers/type4", "stickers/type5", "stickers/type6" ,"stickers/spectacles","stickers/bday"};
    public static final String[] stickerPathName = {"A", "B", "C", "D", "E", "F","G","B'day"};
